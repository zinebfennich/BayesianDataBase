...
/**
 * Cette classe contient des méthodes qui manipulent des structures globales de
 * la base de données, telles que des tables,
 * des colonnes au niveau global, ou des procédures stockées. Elle est centrée
 * sur la gestion des tables, des requêtes SQL
 * générales, ou des opérations globales sur la base de données.
 * Cette classe regroupe des opérations qui agissent au niveau de la structure
...
public class DatabaseUtils {
     ...
     * basées sur les colonnes alphanumériques existantes et les remplir avec
     * hashtext().
     *
    ...
    private static void updateHashedValues(Statement statement, String nomtable) throws SQLException {
        String hashUpdateScript = "DO $$ \n" +
                ...
                + " SET ' || quote_ident(column_record.column_name) || '_num = hashtext(' || quote_ident(column_record.column_name) || '::TEXT);';\n"
                +
                "    END LOOP;\n" +
                "END $$;";
    ...
    /**
     * Insère des données dans la table T_edges_2 en utilisant Khi² ou la
     * corrélation partielle selon les types de variables.
     *
     * @param connection Connexion à la base de données
     * @param tableName  Nom de la table source
     * @param column1    Nom de la première colonne
    ...
    public static void testcall2(Connection connection, String tableName, String column1, String column2,
        ...
        if (!ColumUtils.columnIsNumeric(connection, tableName, column1)
                || (!ColumUtils.columnIsNumeric(connection, tableName, column2))
                || (!ColumUtils.columnIsNumeric(connection, tableName, column3))) {
            ...
            corrValue = PCAlgorithmUtils.performChiSquaredTestForThreeVariables(connection, tableName, binnedColumn1,
                    binnedColumn2, binnedColumn3);
     ...
     */
    private static void updateFlagTEdges2(Connection connection, String tableName, String col1, String col2,
            String col3, double corrValue) throws SQLException {
    ...
    // * @throws SQLException Si une erreur SQL survient
    // */
    // public static void testcall2(Connection connection, String tableName, String
    // column1, String column2, String column3) throws SQLException {
    ...
    // double denominator = Math.sqrt((1 - r_yi_xk * r_yi_xk) * (1 - r_xj_xk *
    // r_xj_xk));
    ...
    // String sql = "INSERT INTO t_edges_2 (sname, node1, node2, node3, corr_part)
    // VALUES (?, ?, ?, ?, ?)";
    // try (PreparedStatement statement = connection.prepareStatement(sql)) {
    // statement.setString(1, tableName);
    // statement.setString(2, column1);
    ...
    // private static Double getCorrelation(Connection connection, String tableName,
    // String node1, String node2) throws SQLException {
    ...
    // * @throws SQLException Si une erreur SQL survient
    // */
    // public static void testcall4(Connection connection, String tableName, String
    // column1, String column2, String column3, String column4) throws SQLException
    // {
    // // Calculer les corrélations
    // double corr12 = calculateCorrelation(connection, tableName, column1,
    // column2);
    // double corr13 = calculateCorrelation(connection, tableName, column1,
    // column3);
    // double corr14 = calculateCorrelation(connection, tableName, column1,
    // column4);
    // double corr23 = calculateCorrelation(connection, tableName, column2,
    // column3);
    // double corr24 = calculateCorrelation(connection, tableName, column2,
    // column4);
    // double corr34 = calculateCorrelation(connection, tableName, column3,
    // column4);
    //
    // // Insérer les résultats dans la table T_edges_ci1
    // insertCorrelations(connection, tableName, column1, column2, column3, column4,
    // corr12, corr13, corr14, corr23, corr24, corr34);
    // }

    // private static double calculateCorrelation(Connection connection, String
    // tableName, String column1, String column2) throws SQLException {
    ...
    // private static void insertCorrelations(Connection connection, String
    // tableName, String column1, String column2, String column3, String column4,
    // double corr12, double corr13, double corr14, double corr23, double corr24,
    // double corr34) throws SQLException {
    // String sql = "INSERT INTO T_edges_ci1 (sname, node1, node2, node3, node4,
    // corr12, corr13, corr14, corr23, corr24, corr34) VALUES (?, ?, ?, ?, ?, ?, ?,
    // ?, ?, ?, ?)";
